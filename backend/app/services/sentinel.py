...
class SentinelService:
    ...
    def _parse_stac_item(self, item) -> dict:
        ...
        # (M5: the pre-titiler local-tiler fallback is gone with the titiler
        #  mount deletion; tile_url stays None if neither STAC asset is
        #  present, which is fine — the UI no longer renders these tile_urls
        #  for fusion; fusion uses /api/fusion/gee-harmonize.)
